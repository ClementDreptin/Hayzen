...
MW2::game_hudelem_s*(_cdecl *MW2::HudElem_Alloc)(int clientNum, int teamNum) = (MW2::game_hudelem_s*(*)(int, int))0x821DF928;

void(_cdecl *MW2::HudElem_Free)(MW2::game_hudelem_s* hud) = (void(*)(MW2::game_hudelem_s*))0x821DF9C0;

int(_cdecl *MW2::G_MaterialIndex)(const char* name) = (int(*)(const char*))0x8220C960;

int(_cdecl *MW2::G_LocalizedStringIndex)(const char* string) = (int(*)(const char*))0x8220C7A0;

MW2::clientState_s*(_cdecl *MW2::GetClientState)(int clientNum) = (MW2::clientState_s*(*)(int))0x821E6610;