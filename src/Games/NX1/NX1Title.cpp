...
void NX1Title::InitMenu()
{
    ...
    // Bot section
    {
        ...
        options.emplace_back(MakeOption(ToggleOption, "Bot Move", NX1::ToggleBotMovement, false));
...
{
    m_DetourMap["SCR_DrawScreenField"] = Detour(0x821AAAA0, SCR_DrawScreenFieldHook);
    m_DetourMap["Scr_Notify"] = Detour(0x822AADE0, Scr_NotifyHook);
    m_DetourMap["SV_ExecuteClientCommand"] = Detour(0x8231B8E8, SV_ExecuteClientCommandHook);
