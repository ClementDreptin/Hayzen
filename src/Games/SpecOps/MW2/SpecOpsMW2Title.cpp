...
SpecOpsMW2Title::SpecOpsMW2Title()
    : m_Console(Console<SpecOpsMW2::Game::dvar_t>::Props(SpecOpsMW2::Game::Cbuf_AddText, SpecOpsMW2::Game::Dvar_ForEach))
{
    WaitUntilReady();
...
void SpecOpsMW2Title::InstallHooks()
{
    m_DetourMap["SCR_DrawScreenField"] = Detour(0x821354B0, SCR_DrawScreenFieldHook);
    m_DetourMap["ClientCommand"] = Detour(0x821EFFD0, ClientCommandHook);

    Title::InstallHooks();
}

void SpecOpsMW2Title::Update()
{
